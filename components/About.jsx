...
const About = () => {
  return (
    <div className='w-full md:h-screen px-4 flex items-center py-16'>
        <div className='max-w-[1400px] m-auto sm:grid items-center bg-gray-200 p-5 justify-items-center grid-cols-3 gap-2'>
