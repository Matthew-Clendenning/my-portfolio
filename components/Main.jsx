        ...
        <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
            <div>
                ...
                <div className='flex items-center justify-evenly max-w-[330px] m-auto py-4 mb-14'>
                  <div className='rounded-full shadow-md shadow-gray-400 p-3 cursor-pointer md:hover:text-[#0077B5] md:hover:scale-110 md:ease-in md:duration-150'>
                    <FaLinkedinIn />
                  </div>
                  <div className='rounded-full shadow-md shadow-gray-400 p-3 cursor-pointer md:hover:scale-110 md:ease-in md:duration-150'>
                    <BsGithub />
                  </div>
                  <div className='rounded-full shadow-md shadow-gray-400 p-3 cursor-pointer md:hover:text-[#0072C6] md:hover:scale-110 md:ease-in md:duration-150'>
                    <AiOutlineMail />
                  </div>
                </div>
