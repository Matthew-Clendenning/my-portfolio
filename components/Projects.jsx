  ...
  return (
    <div id="projects" className='w-full'>
        <div className='max-w-[1240px] mx-auto px-2 py-16'>
            ...
            <div className='grid lg:grid-cols-2 sm:gap-6 gap-10'>
                <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl p-4 sm:hover:scale-105 sm:ease-in-out sm:duration-500 bg-gradient-to-r from-[#ecf0f3] to-[#346f99]'>
                ...
                <div className='sm:max-w-none sm:m-0 max-w-[400px] mx-auto grid content-between justify-center lg:gap-0 gap-10'>
                    <div className='grid gap-6'>
                        <h3 className='font-bold lg:text-left text-center'>Gerrardgroupinc.netlify.app</h3>
                    ...
                    <div className='flex md:justify-normal justify-center gap-6'>
                        <div className='flex items-center gap-4'>
                            ...
                            <h4 className='p-2 h-max text-white bg-blue-500 rounded-lg shadow-md shadow-gray-400 cursor-pointer sm:hover:shadow-blue-500/50 sm:hover:shadow-lg sm:hover:scale-105 sm:ease-in sm:duration-150'>View Site</h4>
                            <span className='rounded-full shadow-md shadow-gray-400 p-1.5 cursor-pointer sm:hover:scale-105 sm:ease-in sm:duration-150'>
